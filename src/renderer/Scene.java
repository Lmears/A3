...
public class Scene {
	...
	public static class Polygon {
		...
		public Vector3D getNormal(){
			Vector3D v01 = vertices[1].minus(vertices[0]);
			Vector3D v12 = vertices[2].minus(vertices[1]);
			return v01.crossProduct(v12);
		}
	...
	public float[] getBoundingBox(){
		...
		float closeBound = Float.POSITIVE_INFINITY;
		float farBound = Float.NEGATIVE_INFINITY;
		...
		return new float[] {leftBound, rightBound, upperBound, lowerBound, closeBound, farBound};
	}
}
