...
public abstract class GUI {
	 ...
	 */
	public int[] getAmbientLight() { return new int[] { ambientR.getValue(), ambientG.getValue(), ambientB.getValue() }; }

	/**
	 * Returns the values of the three sliders used for setting the direct
	 * light of the scene. The returned array in the form [R, G, B] where each
	 * value is between 0 and 255.
	 */
	public int[] getDirectLight() {
		return new int[] { directR.getValue(), directG.getValue(), directB.getValue() };
	}
	...
	private final JSlider ambientR = new JSlider(JSlider.HORIZONTAL, 0, 255, 128);
	private final JSlider ambientG = new JSlider(JSlider.HORIZONTAL, 0, 255, 128);
	private final JSlider ambientB = new JSlider(JSlider.HORIZONTAL, 0, 255, 128);

	private final JSlider directR = new JSlider(JSlider.HORIZONTAL, 0, 255, 128);
	private final JSlider directG = new JSlider(JSlider.HORIZONTAL, 0, 255, 128);
	private final JSlider directB = new JSlider(JSlider.HORIZONTAL, 0, 255, 128);
	...
	private void initialise() {
		...
		directR.setBackground(new Color(230, 50, 50));
		directG.setBackground(new Color(50, 230, 50));
		directB.setBackground(new Color(50, 50, 230));
		...
		sliderparty.add(directR);
		sliderparty.add(directG);
		sliderparty.add(directB);
